        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><div class="request-items-list"><?php foreach($visibleLines as $line): ?><span><strong><?= htmlspecialchars($line['designation'] ?: $line['item']) ?></strong> × <?= htmlspecialchars($line['quantity']) ?></span><?php endforeach; ?><?php if ($hiddenLinesCount > 0): ?><span class="request-items-list__more" title="<?= htmlspecialchars($hiddenLinesCount . ' artigo(s) adicional(is)') ?>">…</span><?php endif; ?></div></td>
