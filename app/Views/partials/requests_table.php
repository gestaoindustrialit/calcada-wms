        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><div class="request-items-list"><?php foreach($visibleLines as $line): ?><span><strong><?= htmlspecialchars($line['item']) ?></strong> × <?= htmlspecialchars($line['quantity']) ?></span><?php endforeach; ?><?php if ($hiddenLinesCount > 0): ?><details class="request-items-list__details"><summary class="request-items-list__more" title="<?= htmlspecialchars('Mostrar mais ' . $hiddenLinesCount . ' artigo(s)') ?>" aria-label="Mostrar mais <?= (int)$hiddenLinesCount ?> artigo(s)">…</summary><div class="request-items-list__extra"><?php foreach(array_slice($r['lines'], count($visibleLines)) as $line): ?><span><strong><?= htmlspecialchars($line['item']) ?></strong> × <?= htmlspecialchars($line['quantity']) ?></span><?php endforeach; ?></div></details><?php endif; ?></div></td>
