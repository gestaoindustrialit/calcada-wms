...
$inventoryLocationPayload = array_map(fn($r) => ['item_id'=>(int)$r['item_id'], 'warehouse_id'=>(int)$r['warehouse_id'], 'location'=>(string)($r['location'] ?? ''), 'quantity'=>(float)$r['quantity'], 'min_quantity'=>0], $inventoryRows);
...
?>
<div class="page-head"><div><span class="eyebrow">Stock em tempo real</span><h1>Inventário</h1><p>Filtre por artigo ou armazém e registe movimentos de entrada ou saída.</p></div></div>
...
<div class="row g-3 mb-4">
    <div class="col-md-6"><div class="inventory-stat"><small>Linhas filtradas</small><strong><?= (int)$summary['lines'] ?></strong></div></div>
    <div class="col-md-6"><div class="inventory-stat"><small>Quantidade total</small><strong><?= number_format((float)$summary['quantity'], 2, ',', '.') ?></strong></div></div>
</div>
