...
<div class="grid-two mb-4">
    <section class="panel-card">
        ...
        <form method="post" class="row g-3" data-smart-form>
            ...
            <div class="col-12"><button class="btn btn-primary"><?= $isEdit ? 'Guardar armazém' : 'Adicionar armazém' ?></button></div>
        </form>
    </section>
