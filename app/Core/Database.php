...
class Database
{
    ...
    private static function migrate(): void
    {
        ...
        self::$pdo->exec("CREATE TABLE IF NOT EXISTS purchase_requests (id INTEGER PRIMARY KEY AUTOINCREMENT, requester_name TEXT, requester_team TEXT, article_name TEXT NOT NULL, quantity REAL NOT NULL, link TEXT, urgency INTEGER NOT NULL DEFAULT 1, status TEXT NOT NULL DEFAULT 'Pendente', status_changed_at TEXT, created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP)");
        self::ensureColumn('purchase_requests', 'status_changed_at', 'TEXT');
        self::$pdo->exec("CREATE TABLE IF NOT EXISTS purchase_status_history (id INTEGER PRIMARY KEY AUTOINCREMENT, purchase_request_id INTEGER NOT NULL, old_status TEXT, new_status TEXT NOT NULL, changed_by TEXT, changed_role TEXT, changed_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY(purchase_request_id) REFERENCES purchase_requests(id))");
        self::$pdo->exec("CREATE TABLE IF NOT EXISTS material_requests (id INTEGER PRIMARY KEY AUTOINCREMENT, responsible TEXT NOT NULL, requester_name TEXT, requester_team TEXT, department TEXT NOT NULL, product TEXT NOT NULL, operation TEXT NOT NULL, quantity REAL NOT NULL, completed_quantity REAL NOT NULL DEFAULT 0, urgency INTEGER NOT NULL DEFAULT 1, due_date TEXT NOT NULL, status TEXT NOT NULL DEFAULT 'A Aguardar', notes TEXT, attachment_name TEXT, created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP)");
