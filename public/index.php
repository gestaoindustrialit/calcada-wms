...
$routes = [
    ...
    'maintenance_status'=>fn()=> $controller->maintenanceStatus(),
    'events'=>fn()=> $controller->events(),
    'event_reservations'=>fn()=> $controller->eventReservations(),
    'event_validate'=>fn()=> $controller->eventValidate(),
    'event_reset'=>fn()=> $controller->eventReset(),
    'event_email'=>fn()=> $controller->eventEmail(),
    'material_save'=>fn()=> $controller->saveMaterial(),
    'material_status'=>fn()=> $controller->materialStatus(),
    'material_download'=>fn()=> $controller->materialDownload(),
